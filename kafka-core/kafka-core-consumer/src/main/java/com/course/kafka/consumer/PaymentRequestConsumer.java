...
//
//		PaymentRequestCacheKey cacheKey = new PaymentRequestCacheKey(paymentRequest.getPaymentNumber(), paymentRequest.getAmount(),
//				paymentRequest.getTransactionType());
//		boolean processed = isExistsInCache(cacheKey);
//
//		if (processed) {
//			return;
//		}
