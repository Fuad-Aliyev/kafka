...
public class Image2Consumer {
	...
	@RetryableTopic(
			autoCreateTopics = "true", //will generate new topic auto to handle non blocking mechanism
			attempts = "4",
			topicSuffixingStrategy = TopicSuffixingStrategy.SUFFIX_WITH_INDEX_VALUE, // auto topic naming strategy
	...
	public void consume(ConsumerRecord<String, String> consumerRecord) throws JsonMappingException, JsonProcessingException {
		Image image = objectMapper.readValue(consumerRecord.value(), Image.class);
